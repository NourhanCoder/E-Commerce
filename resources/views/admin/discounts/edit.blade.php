            ...
            <div class="x_content">
                ...
                <form action="{{ route('admin.discounts.update', $discount->id) }}" method="POST">
                    ...
                    <div class="form-group">
                        ...
                        <input type="datetime-local" name="start_date" id="start_date" class="form-control" value="{{ old('start_date', $discount->start_date) }}" required>
                    </div>

                    <div class="form-group">
                        <label for="end_date">End Date & Time</label>
                        <input type="datetime-local" name="end_date" id="end_date" class="form-control" value="{{ old('end_date', $discount->end_date) }}" required>
                    </div>
